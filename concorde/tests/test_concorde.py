...
class TestGetSources(unittest.TestCase):
    ...
    def test_none(self):
        files = concorde.get_source_files(['.'])
        self.assertItemsEqual([], files)

    def test_recursive(self):
        files = concorde.get_source_files(['site'], recurse=True)
    ...
    def test_not_recursive(self):
        files = concorde.get_source_files(['site'], recurse=False)
        self.assertItemsEqual(['site/page.md', 'site/another-page.markdown'], files)

        files = concorde.get_source_files(['site/blog'], recurse=False)
        self.assertItemsEqual(['site/blog/post-1.md', 'site/blog/post-2.md'], files)

    def test_mix_dirs_files(self):
        files = concorde.get_source_files(['site/page.md', 'site/blog'], recurse=True)
        self.assertItemsEqual(['site/page.md', 'site/blog/post-1.md', 'site/blog/post-2.md'], files)
